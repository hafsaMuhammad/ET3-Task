...
@section('content')
    ...
    <h1 class = " text-center p-5 display-3">orders</h1>
    <div class= 'container'>
        ...
        <div >
            <form action="{{route('orders.create')}}"  method="POST" class="form-create text-center">
                @csrf
                @method('GET')
                <button type="submit" class="btn btn-warning btn-lg my-3">Create New order</button>
            </form>
        ...
        <table class="table table-warning">
            ...
            @foreach ($orders as $order)
                <tr>
                  ...
                  <td>
                    <a href="{{route('orders.edit',$order->id)}}" class="btn btn-success mx-2">Edit</a>
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <form action="{{route('orders.show',$order->id)}}"  method="POST" class="form-show">
                            @csrf
                            @method('GET')
